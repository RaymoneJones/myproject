...
<!--    申请-->
    <div class="tab-pane fade" id="third">
        <ul id="myOrder" class="nav nav-tabs">
            <li class="active"><a href="#third1" data-toggle="tab">全部</a></li>
            <li><a href="#third2" data-toggle="tab">待处理</a></li>
            <li><a href="#third3" data-toggle="tab">已批准</a></li>
            <li><a href="#third4" data-toggle="tab">已拒绝</a></li>

        </ul>
        <div id="myTabContent2" class="tab-content">
<!--            全部-->
            <div class="tab-pane fade in active" id="third1">
                <table class="table">
                    <thead>
                    <tr>
                        <th>编号</th><th>物品名称</th><th>类别</th><th>申请人</th><th>申请日期</th><th>状态</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    if($num--){
                        while($row=$result->fetch_assoc()){
                            ...
                            echo '<tr><td>'.$row['no'].'</td><td>'.$row['goods'].'</td><td>'.$row['goods_class'].'</td><td>'.$row['apply_person'].'</td>
                                    <td>'.$row['apply_date'].'</td><td>'.$sstate.'</td>';
                        }
                    }
...
<!--            待处理-->
            <div class="tab-pane fade" id="third2">
                <table class="table">
                    ...
                    <tbody>
                    <?php
                    $sql="select * from tb_apply where state=0";
                    $result=mysqli_query($con,$sql);
                    $num=10;
                    $sstate='待处理';
                    if($num--){
...
<!--            已批准-->
            <div class="tab-pane fade" id="third3">
                <table class="table">
                    ...
                    <tbody>
                    <?php
                    $sql="select * from tb_apply where state=1";
                    $result=mysqli_query($con,$sql);
                    $num=10;
                    $sstate='已批准';
                    if($num--){
...
<!--已拒绝-->
            <div class="tab-pane fade" id="third4">
                <table class="table">
                    <thead>
                    <tr>
                        <th>编号</th><th>物品名称</th><th>类别</th><th>申请人</th><th>申请日期</th><th>状态</th>
                    ...
                    <tbody>
                    <?php
                    $sql="select * from tb_apply where state=2";
                    $result=mysqli_query($con,$sql);
                    $num=10;
                    $sstate='已拒绝';
                    if($num--){
...
<!--    报销-->
    <div class="tab-pane fade" id="forth">
        <ul id="myOrder" class="nav nav-tabs">
            <li class="active"><a href="#forth1" data-toggle="tab">全部</a></li>
            <li><a href="#forth2" data-toggle="tab">待处理</a></li>
            <li><a href="#forth3" data-toggle="tab">已批准</a></li>
            <li><a href="#forth4" data-toggle="tab">已拒绝</a></li>

        </ul>
            <div id="myTabContent2" class="tab-content">
                <!--            全部-->
                <div class="tab-pane fade in active" id="forth1">
                    <table class="table">
                        <thead>
                        <tr>
                            <th>编号</th><th>报销人</th><th>提交日期</th><th>报销金额（￥）</th><th>状态</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
                        ...
                        if($num--){
                            while($row=$result->fetch_assoc()){
                                ...
                                echo '<tr><td>'.$row['no'].'</td><td>'.$row['a_p'].'</td><td>'.$row['a_d'].'</td>
                                    <td>'.$row['a_m'].'</td><td>'.$sstate.'</td>';
                            }
                        }
                ...
                <!--            待处理-->
                <div class="tab-pane fade" id="forth2">
                    <table class="table">
                        <thead>
                        <tr>
                            <th>编号</th><th>报销人</th><th>提交日期</th><th>报销金额（￥）</th><th>状态</th>
                        ...
                        <tbody>
                        <?php
                        $sql="select * from tb_expense where state=0";
                        $result=mysqli_query($con,$sql);
                        $num=10;
                        $sstate='待处理';
                        if($num--){
                ...
                <!--            已批准-->
                <div class="tab-pane fade" id="forth3">
                    <table class="table">
                        <thead>
                        <tr>
                            <th>编号</th><th>报销人</th><th>提交日期</th><th>报销金额（￥）</th><th>状态</th>
                        ...
                        <tbody>
                        <?php
                        $sql="select * from tb_expense where state=1";
                        $result=mysqli_query($con,$sql);
                        $num=10;
                        $sstate='已批准';
                        if($num--){
                ...
                <!--已拒绝-->
                <div class="tab-pane fade" id="forth4">
                    <table class="table">
                        <thead>
                        <tr>
                            <th>编号</th><th>报销人</th><th>提交日期</th><th>报销金额（￥）</th><th>状态</th>
                        ...
                        <tbody>
                        <?php
                        $sql="select * from tb_expense where state=2";
                        $result=mysqli_query($con,$sql);
                        $num=10;
                        $sstate='已拒绝';
                        if($num--){
