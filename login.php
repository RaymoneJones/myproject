...
if(isset($_POST['radio'])&&$_POST['radio']==1)
{
	if(isset($_POST['username'])&&isset($_POST['password']))	{
		$check="select * from tb_user where user_name='".$_POST['username']."'and user_password='".$_POST['password']."'";
		if($conne->getRowsNum($check) == 1){
			...
			$_SESSION["userfoundtime"]=$conne->getFields($check,'user_foundtime');  //定义入职日期
